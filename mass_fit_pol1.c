 ...
 *                                
 */
   RooRealVar* ups1smdimucoef1 = new RooRealVar("Upsilon(1S) mass","Upsilon(1S) mass",9.45, 9.0, 10.0);
...
//    RooRealVar* nmm = new RooRealVar("N(dimuon events)","number of signal events",103.0);
 ...
 // RooRealVar* ratiom2 = new RooRealVar("N2onN1S","ratio Upsilon(2S) mass",0.26);    // for 2s/1s ratio fix
 // RooRealVar* ratiom3 = new RooRealVar("N3onN1S","ratio Upsilon(3S) mass",0.13);  // for 3s/1s ratio fix
...
//  RooGaussian* ups3 = new RooGaussian("ups3s sigpeak","ups3s sigpeak", *mMuMu,*ups3smdimucoef1,width3s);//scale width
  RooGaussian* ups2 = new RooGaussian("ups2s sigpeak","ups2s sigpeak", *mMuMu,meanup2s,width2s);// width and mass free <- no
  RooGaussian* ups3 = new RooGaussian("ups3s sigpeak","ups3s sigpeak", *mMuMu,meanup3s,width3s);// width and mass free <- no
