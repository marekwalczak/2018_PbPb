...
cout << endl << "******* making histos *******" << endl << endl;
  ...
  histo_QQ_rap->GetYaxis()->SetRangeUser(0,250);
...
//*************** MUON rap *******************//
  ...
  histo_mu_rap->GetYaxis()->SetRangeUser(0,500);
...
//*************** SP - MUON pT vs rap *******************//
 ...
 // sp_mu_pT_mu_rap->GetYaxis()->SetRangeUser(0,500);
  ...
  histo_QQ_pT->GetXaxis()->SetRangeUser(-5,5);
  histo_QQ_pT->GetYaxis()->SetRangeUser(0,250);
